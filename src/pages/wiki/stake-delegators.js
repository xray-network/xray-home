  ...
  return (
    <LayoutWiki>
      ...
      <p>
        ...
        <span className="ray__ticker">XRAY</span> tokens to Ray pools
        delegators.
      </p>
      ...
      <p>
        You must delegate <span className="ray__ticker">ADA</span> to the Ray
        pools. This can be done through various wallets such as Ray Wallet,
      ...
      <ul>
        ...
        <li>
          ...
          <Link to="/stake/pools/">Stake &rarr; Pools</Link> section)
        </li>
      </ul>

      <div className="ray__line mb-4" />
      <h5>
        <strong>How many rewards will I get?</strong>
      </h5>
      <p>
      ...
      <ul>
        <li>
          ~0.07% in <span className="ray__ticker">ADA</span> per epoch (~5% ROI)
        </li>
        <li>
          1 <span className="ray__ticker">XRAY</span> per 50{" "}
          <span className="ray__ticker">ADA</span> per epoch (rate may vary, see
          distribution rules)
        </li>
      </ul>
      ...
      <div className="ray__line mb-4" />
      <h5>
        <strong>When can I get XRAY rewards?</strong>
      </h5>
      ...
      <p>
        <strike>
          Additional early delegators bonus (1,538,200 XRAY) available for
      ...
      <p>
        You can check or withdraw your <span className="ray__ticker">XRAY</span>{" "}
        or <span className="ray__ticker">ADA</span> rewards in Ray Wallet. If
        you don't use Ray Wallet, do so on the token distribution page{" "}
        <Link to="/stake/track/">Stake &rarr; Track & Withdraw</Link>.
      </p>

      <div className="ray__line mb-4" />
      <h5>
        <strong>Where can I see the distribution rules?</strong>
      </h5>
      <p>
        Visit the token distribution page{" "}
        <Link to="/xray/distribution/">XRAY &rarr; Distribution</Link>.
      </p>
      ...
      <p>
        ...
        <span className="ray__ticker">ADA</span>, this is a limitation of
        Cardano. Minimum amount of <span className="ray__ticker">ADA</span> sent
        together with token is ~1.5 (it will be returned to you with{" "}
        <span className="ray__ticker">XRAY</span> rewards) and ~0.5 as
        transaction fee.
      </p>
      <p>
        Therefore, we require 2 <span className="ray__ticker">ADA</span> to be
        sent to a special address to cover these costs.
      </p>

      <div className="ray__line mb-4" />
      <h5>
        <strong>Can I use the Hardware Wallet for delegation?</strong>
      </h5>
      <p>
        Implementation of hardware wallets is still in progress, so you can use
        any other wallet that supports hardware wallets.
      </p>
    </LayoutWiki>
  )
}
