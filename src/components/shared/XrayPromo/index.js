  ...
  return (
    <div className="ray__block">
      <div className="ray__promo">
        <h1 className="ray__promo__text" data-aos="fade-up" data-aos-delay="000">
        ...
        <div className="d-block d-md-flex font-size-18" data-aos="fade-up" data-aos-delay="600">
          <Link to="/xray/distribution/" className="ray__btn ray__btn--round me-3 mb-3">
            Distribution
          </Link>
          <Link to="/xray/tokenomics/" className="ray__btn ray__btn--round me-3 mb-3">
            Tokenomics
          </Link>
          <Link to="/xray/tokenomics/" className="ray__btn ray__btn--round me-3 mb-3">
            XDIAMOND
