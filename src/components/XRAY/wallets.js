  ...
  return (
    <div className="ray__block">
      ...
      <div className="ray__left ray__left--dark mb-4">
        ...
        <p className="mb-3">
          Used to withdraw rewards from the RayStake (ADA Staking & XRAY ISPO Program, LP Tokens Staking). Soon to be replaced by a smart contract
        </p>
        <a
      ...
      <div className="ray__left ray__left--dark mb-4">
        <h5 className="mb-3">
          <strong>XDIAMOND Collateral Wallet</strong>
        </h5>
        <p className="mb-3">
          Collateral wallet with <span className="ray__ticker">XRAY</span> for
          redeeming <span className="ray__ticker">XDIAMOND</span> with rate 1{" "}
          <span className="ray__ticker">XDIAMOND</span> = 100{" "}
          <span className="ray__ticker">XRAY</span>
        </p>
        <a
          className="text-break"
          href="https://cardanoscan.io/address/addr1q9j55y5p7lyq3esn7xwrae5k9ez30639dj3ct7pp6fjkavvhuchtelm0kpr4pfvht57xcx4qd80tr3q9gg4s9h3d22uqjxm9p9"
        >
