      ...
      <div className="mb-4">
        <div className="row">
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={(stakeTotal || 0) * (stakeDataXrayPrice?.price || 0) * (prices?.cardano?.usd || 0) + (((pools?.totalLiveStake / 1000000) || 0) * (prices?.cardano?.usd || 0))} title="Total Value Locked" ticker="$" large decimals={false} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={stakeTotal} title="XRAY TVL" ticker="XRAY" large decimals={false} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={(pools?.totalLiveStake / 1000000) || 0} title="ISPO ADA TVL" ticker="ADA" large decimals={false} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={(pools?.nextRate / 1000000) || 0} title="ISPO Live Mining Rate" ticker="ADA" large decimals={true} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={stakeDataKeysTotal?.unique || 0} title="Stake Keys Involved" large decimals={false} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={stakeDataXrayPrice?.price || 0} title="XRAY Price" ticker="ADA" large decimals={true} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={(stakeDataXrayPrice?.price || 0) * (prices?.cardano?.usd || 0)} title="XRAY Market Price" ticker="$" large decimals={true} />
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Counter amount={prices?.cardano?.usd || 0} title="ADA Market Price" ticker="$" large decimals={true} />
          </div>
        </div>
      </div>
