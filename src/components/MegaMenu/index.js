    ...
    <div className={style.fixed} id="mega-menu">
      ...
      <div className="ray__block pt-3 mb-0">
        <div className="pb-5 overflow-hidden">
            ...
            <div className="row">
              <div className="col-12 col-md-8 mb-3">
                <div className={`${style.footerLists} row`}>
                  <div className="col-6 col-sm-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul className="list-unstyled mb-5">
                      ...
                      <li>
                        <a href="https://raynetwork.io/community/">Developers</a>
                      </li>
                      <li>
                  ...
                  <div className="col-6 col-sm-4" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="#mega-menu">
                    <div className="d-flex mb-4">
                      <h6 className="mb-0">
                  ...
                  <div className="col-12 col-sm-4" data-aos="fade-up" data-aos-delay="600" data-aos-anchor="#mega-menu">
                    <div className="row">
          ...
          <div className="row" data-aos="fade-up" data-aos-delay="900" data-aos-anchor="#mega-menu">
            ...
            <div className="col-12 col-md-6">
              <div className={style.wallets}>
                <a href="https://raywallet.io" target="_blank" rel="noopener noreferrer">
                  <img src={imgWallet2} alt="RayWallet" />
                  <span className="ant-btn ray__btn ray__btn--round">RayWallet</span>
                </a>
                <a href="https://raywallet.io" target="_blank" rel="noopener noreferrer">
                  <img src={imgWallet1} alt="RayWallet" />
                  <span className="ant-btn ray__btn ray__btn--round ray__btn--white">RayWallet</span>
                </a>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6">
            <p className="mb-2 font-size-14">Advanced Ecosystem for Cardano Blockchain Platform</p>
            <p className="mb-0 font-size-14">{new Date().getFullYear()} &copy; Ray Foundation DAO</p>
          </div>
        </div>
      </div>
    </div>
