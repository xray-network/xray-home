    ...
    <div className="ray__block">
      <div className={style.features}>
        ...
        <p>
          ...
          swap, NFT marketplace, staking center and others.
        </p>
        <p>
          Our services increase blockchain use adoption; they empowers regular
          users, developers, creators, liquidity providers and traders to
        ...
        <p className="mb-5">
          ...
          SAAS platform that helps hundreds of technology companies around the
          world build web applications. Sellpixels.com provides full circle
          software development services such as frontend, backend,
          microservices, ci/cd, ui/ux, and more.
        </p>
        <div className="row">
            ...
            <div key={index} className="col-lg-4 col-sm-6 col-12">
              <div className={style.item}>
                <div className={style.icon}>
                  <span className="ray__icon">{item.icon}</span>
                </div>
