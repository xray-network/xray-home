...
const XrayDistribution = () => {
  ...
  const epochStats = rewards.distributed.filter((item) => item.epoch === rewards.currentEpoch)[0] || {}
  ...
  return (
    <div className="ray__block">
      ...
      <p>
        Ray Network provides Cardano staking services on high-performance servers in the Cloudflare cloud. High availability, high uptime, low latency and automated infrastructure deployment allow for the highest possible ROI.
      </p>
      <p className="mb-5">
      ...
      <h5><strong>Payout statistics in Epoch {rewards.currentEpoch}</strong></h5>
      <div className="row mb-4">
        <div className="col-12 col-sm-4 mb-4">
          <div className="ray__left ray__left--dark">
            <div className="ray__card__value">
              {format(epochStats.xray || 0)} <span className="ray__ticker">XRAY</span>
            </div>
        ...
        <div className="col-12 col-sm-4 mb-4">
          <div className="ray__left ray__left--dark">
            <div className="ray__card__value">
              {format(epochStats.maxRewards || 0)} <span className="ray__ticker">XRAY</span>
            </div>
        ...
        <div className="col-12 col-sm-4 mb-4">
          <div className="ray__left ray__left--dark">
            <div className="ray__card__value">
              {format(epochStats.rate ? epochStats.rate / 1000000 : 0)} <span className="ray__ticker">ADA</span>{' '}
              /{' '}
