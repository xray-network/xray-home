  ...
  return (
    <div className={`${style.cookies} ${cookiesViewed && "d-none"} ${cookiesAnimation && style.cookiesAnimated}`}>
      ...
      <p className={style.description}>
        Cookies can enable us to track and target the interests of our users to enhance the experience on our site, and
        for advertising purposes. Usage of a cookie is in no way linked to any personally identifiable information on
        our website.
      </p>
      <a
        href="/"
