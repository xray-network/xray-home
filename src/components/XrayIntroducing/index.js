  ...
  return (
    <div className="ray__block">
      ...
      <p className="mb-5">
        ...
        <br />
        More info: <strong className="text-active"><a href="https://cardanoscan.io/token/a91ed340458166d57f29b019ce7b2d07e08a07cf" target="_blank" rel="noopener noreferrer">View in Explorer</a></strong>
      </p>
      <h5 className="mb-5">
      ...
      <p className="mb-5">
        We are a completely open and non-anonymous team, more details in <Link to="/about/">About</Link> section.
      </p>
      <h5 className="mb-5">
