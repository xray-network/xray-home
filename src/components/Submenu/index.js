  ...
  return (
    <div className="ray__block mb-0">
      <div className={`${style.mobileMenu} d-block d-md-none`}>
        <Link
          to="/ecosystem/"
          className={isEcosystem ? style.linkMobileActive : ""}
          activeClassName={style.linkMobileActive}
        >
          Ecosystem
        </Link>
        <Link
          to="/xray/"
          className={isXRAY ? style.linkMobileActive : ""}
          activeClassName={style.linkMobileActive}
        >
          XRAY
        </Link>
        <Link
          to="/developers/"
          className={isDevelopers ? style.linkMobileActive : ""}
          activeClassName={style.linkMobileActive}
        >
          Developers
        </Link>
