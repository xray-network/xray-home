      ...
      <div className="row mb-5">
        <div className="col-12 col-md-8 pe-md-5">
          <div className="ray__left ray__left--dark">
            <h1 className="ray__promo__text">
              <strong className="bolder">
                <span className="ray__ticker ray__ticker--inverse ray__ticker__large">XDIAMOND</span>, marketing and rewarding NFT token
              </strong>
            </h1>
          </div>
          ...
          <p className="mb-5">
            ...
            <br />
            Distribution:{" "}
            <strong>16,000 to early delegators, 10,000 for the community, 5,000 for further incentives</strong>
          </p>
