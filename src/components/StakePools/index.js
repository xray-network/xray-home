...
const XrayPools = () => {
  ...
  return (
    <div className="ray__block">
      ...
      <p className="mb-5">
        Use any Cardano wallet (Ray Wallet, Daedalus, Yoroi, Adalite, or any
              ...
              <div className={style.pool}>
                  ...
                  <div className={style.poolValue}>
                    ...
                    >
                      <strong className={style.copy}>
                        {pool.pId && pool.pId.substring(0, 8)}...
                        {pool.pId && pool.pId.slice(-8)}
                ...
                <div className={style.poolItem}>
                  ...
                  <div className={style.poolValue}>
                    ...
                    >
                      <strong className={style.copy}>
                        {pool.pHash && pool.pHash.substring(0, 8)}...
                        {pool.pHash && pool.pHash.slice(-8)}
                        <span className="ray__icon ray__icon--inline ms-2">
                          <SVGFiles />
                        </span>
                      </strong>
