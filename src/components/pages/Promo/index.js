  ...
  return (
    <div className="ray__block ray__block--hidden">
      <div className={style.promo}>
        ...
        <p className="mt-4 pt-2">Get <strong>5% ROI in ADA</strong> by delegating funds to a Ray pools and receive additional rewards: <strong>1 XRAY per each 50 ADA / Epoch</strong>.</p>
        <div>
